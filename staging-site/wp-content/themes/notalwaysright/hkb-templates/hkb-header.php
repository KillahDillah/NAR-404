...
></a>
  ...
  <div id="navs_social_fb"><div class="fb-like" data-href="https://facebook.com/notalwaysright" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div></div><!--// END CUSTOM 11/21/15 Navbar FB Like shuffle //-->
    <div id="navs_social_ig"><a href="//www.youtube.com/channel/UCGEQHGktMOJfXF5o3Peunew"><img src="/wp-content/themes/notalwaysright/images/nan_flat_youtube_color.png" alt="Not Always Right: YouTube" title="Not Always Right: YouTube" /></a></div>
...
?>">Random Story</a></li>
    ...
    <li class="hamburger_nav hamburger_nav_unimportant"><a href="/terms-of-use">Terms of Use</a></li>
            ...
            <a href="//www.youtube.com/channel/UCGEQHGktMOJfXF5o3Peunew"><img src="//notalwaysright.com/wp-content/themes/notalwaysright/images/flaticon_youtube_red.png" class="mobile_icons_social" alt="Not Always Right on YouTube" /></a></div>
                </li>
...
?>"><div class="post_supernav_link_right" id="pslr_random">Random</div></a>
          <a href="/add-story/"><div class="post_supernav_link_right" id="pslr_add">Add Story</div></a>
        </div>
                        </div>
    ...
    <div class="container" id="main_content">
      <div class="row"> <!--// margin-left: 0px;  //-->
        <div class="span8"> <!--// margin-left: -10px; //-->
